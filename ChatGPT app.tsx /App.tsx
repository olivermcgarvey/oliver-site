...
const unknownPicturesLogo = "/assets/shared/logos/unknown-pictures-logo.svg";
    ...
    <>
      ...
      <div
        ...
        style={{
          position: "fixed",
          inset: 0,
          zIndex: mobileMenuOpen ? 74 : -1,
          pointerEvents: mobileMenuOpen ? "auto" : "none",
          background: mobileMenuOpen ? "rgba(0,0,0,0.14)" : "rgba(0,0,0,0)",
        ...
        >
          <button
            ...
            style={{
              ...
              padding: 0,
              margin: 0,
              opacity: section === "narrative" && hasEntered ? 0.98 : 0.82,
            }}
          >
            Narrative
          </button>
          ...
          <button
            ...
            style={{
              ...
              padding: 0,
              margin: 0,
              opacity: section === "commercial" && hasEntered ? 0.98 : 0.82,
            }}
          >
            Commercial
          </button>
          ...
          >
            ...
            <span
              style={{
                display: "inline-block",
                transform: mobileAboutOpen ? "rotate(45deg)" : "rotate(0deg)",
          ...
          >
            ...
            >
              ...
              <div style={{ marginBottom: 12 }}>
                Working across narrative and commercial film, his projects span documentary, slow-cinema, fashion, and commissioned work, with a focus on atmosphere and formal restraint, allowing emotions to surface. His work has been featured in Nowness, The Guardian, The Times, i-D, Vogue and Vanity Fair among other publications.
              </div>
        ...
        <>
          ...
          <div
            style={{
              ...
              transform: isBioOpen ? "translateY(0)" : "translateY(-22px)",
              pointerEvents: isBioOpen ? "auto" : "none",
              transition: "opacity 620ms ease, transform 620ms ease",
              padding: "36px 38px 40px 38px",
              boxSizing: "border-box",
              display: "grid",
              gridTemplateColumns: "430px 260px",
              columnGap: 54,
              alignItems: "start",
              backdropFilter: "blur(4px)",
            }}
          >
            ...
            >
              ...
              <div>
                Featured in Nowness, The Guardian, The Times,<br />
            ...
            >
              ...
              <div
                style={{
                  display: "grid",
                  gridTemplateColumns: "118px 128px",
                  columnGap: 14,
                  alignItems: "start",
                  width: "100%",
                }}
